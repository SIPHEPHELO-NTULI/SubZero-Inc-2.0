...
class _SellScreen extends State<SellScreen> {
  ...
  Future<void> addProduct() {
    ...
    return Product.doc(uid)
        .set({
          'imageURL':
              "https://firebasestorage.googleapis.com/v0/b/swapshop-bfda8.appspot.com/o/00KJqayaS782TLb8pWhD%2FimagesUrls%2Fpost_1652988110143?alt=media&token=6d3baa6e-0ddd-4d56-892a-eb83284848a0",
          'price': Price, // S
          ...
          children: [
            ...
            ElevatedButton(
                onPressed: () async {
                  ...
                  print(downloadURL);
                  var snackBar = SnackBar(content: Text('Product Uploaded'));
                  // Step 3
